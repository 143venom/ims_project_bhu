...
def company_info_create(request):
    if CompanyInfo.objects.exists():
        ...
        return render(request, "company_info_create.html", {"form": form})
    
@login_required
def company_info_detail(request):
    company = CompanyInfo.objects.first()
    return render(request, "company_info_detail.html", {"company": company})

@login_required
def update_profile(request):
    context['page_title'] = 'Update Company Info'
